...
FeaturedBoatsModel featuredBoatsModelFromJson(String str) =>
    FeaturedBoatsModel.fromJson(json.decode(str));

String featuredBoatsModelToJson(FeaturedBoatsModel data) =>
...
class DatumTest {
  ...
  factory DatumTest.fromJson(Map<String, dynamic> json) => DatumTest(
        ...
        images: json["images"] == null
            ? []
            : List<DatumImage>.from(
                json["images"]!.map((x) => DatumImage.fromJson(x))),
        ...
        itineraries: json["itineraries"] == null
            ? []
            : List<dynamic>.from(json["itineraries"]!.map((x) => x)),
        bookingTypes: json["bookingTypes"] == null
            ? []
            : List<BookingType>.from(
                json["bookingTypes"]!.map((x) => BookingType.fromJson(x))),
        unavailableDate: json["unavailableDate"] == null
            ? []
            : List<UnavailableDate>.from(json["unavailableDate"]!
  ...
  Map<String, dynamic> toJson() => {
        ...
        "itineraries": itineraries == null
            ? []
            : List<dynamic>.from(itineraries!.map((x) => x)),
        "bookingTypes": bookingTypes == null
            ? []
            : List<dynamic>.from(bookingTypes!.map((x) => x.toJson())),
        "unavailableDate": unavailableDate == null
            ? []
            : List<dynamic>.from(unavailableDate!.map((x) => x.toJson())),
      };
}
...
class Cruise {
  ...
  factory Cruise.fromJson(Map<String, dynamic> json) => Cruise(
        ...
        cruiseType: json["cruiseType"] == null
            ? null
            : CruiseType.fromJson(json["cruiseType"]),
        images: json["images"] == null
            ? []
