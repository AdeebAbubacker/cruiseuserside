...
CategorySearchModel CategorySearchModelFromJson(String str) =>
    CategorySearchModel.fromJson(json.decode(str));

String CategorySearchModelToJson(CategorySearchModel data) =>
