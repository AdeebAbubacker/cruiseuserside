...
class GuestExploreDestintionWidget extends StatefulWidget {
  const GuestExploreDestintionWidget({
    super.key,
  ...
  @override
  State<GuestExploreDestintionWidget> createState() =>
      _GuestExploreDestintionWidgetState();
}

class _GuestExploreDestintionWidgetState
    extends State<GuestExploreDestintionWidget> {
