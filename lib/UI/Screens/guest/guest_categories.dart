import 'package:cruise_buddy/UI/Screens/guest/guest_categories_list_result_screen.dart';
...
class GuestCategoriesSection extends StatefulWidget {
  const GuestCategoriesSection({
    super.key,
  });

  @override
  State<GuestCategoriesSection> createState() => _GuestCategoriesSectionState();
}

class _GuestCategoriesSectionState extends State<GuestCategoriesSection> {
  List<double> _scales = [];
                ...
                itemBuilder: (context, index) {
                  return Padding(
                    ...
                    child: Shimmer.fromColors(
                      ...
                      highlightColor: const Color.fromARGB(31, 233, 231, 231),
                      child: Container(
                  ...
                  return GestureDetector(
                    onTap: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => GuestCategoriesListResultScreen(
