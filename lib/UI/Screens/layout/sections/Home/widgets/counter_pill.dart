        ...
        children: [
          ...
          IconButton(
            onPressed: () {
              if (counter > 0) {
                ...
                widget.onRoomCountChanged?.call(
                    counter); // 👈 Call the callback when counter changes
              }
            },
          ...
          IconButton(
            onPressed: () {
              ...
              widget.onRoomCountChanged
                  ?.call(counter); // 👈 Call the callback when counter changes
            },
            icon: Icon(Icons.add),
          ),
          Spacer(),
